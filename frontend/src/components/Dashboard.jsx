...
export default function Dashboard({ stats, packets }) {
    ...
    const topProtocol = Object.entries(stats?.protocols || {}).sort((a,b) => b[1]-a[1])[0]?.[0];
    ...
    return (
        <div className={styles.dashboard}>
            <div className={styles.cards}>
                ...
                <Card label="Top Protocol" value={topProtocol} color={PROTOCOL_COLOURS[topProtocol]}></Card> {/* Change colour based on protocol shown */}
